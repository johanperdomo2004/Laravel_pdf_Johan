...
<html>
  ...
  <body class="bg-gray-300">
   <header>
     <nav class="mx-auto block absolute top-0 w-full rounded-xl border border-white/80 bg-white bg-opacity-80 py-2 px-4 text-white shadow-md backdrop-blur-2xl backdrop-saturate-200 lg:px-8 lg:py-4">
        <div>
          <div class="container mx-auto flex items-center justify-between text-gray-500">
            <a
              href="#"
            ...
            <button
              class="middle none center hidden rounded-lg bg-gradient-to-tr from-gray-600 to-gray-900 py-2 px-4 font-sans text-xs font-bold uppercase text-white shadow-md shadow-sky-500/20 transition-all hover:shadow-lg hover:shadow-blue-500/40 active:opacity-[0.85] disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none lg:inline-block"
              type="button"
              data-ripple-light="true"
            >
              <span>JOHAN GORDO</span>
            </button>
            <button
  ...
  <div
    class="sidebar fixed top-0 bottom-0 lg:left-0 p-2 w-[300px] overflow-y-auto text-center bg-gray-800"
  >
    <div class="text-gray-100 text-xl">
      <div class="p-2.5 mt-1 flex items-center">
        <i class="bi bi-app-indicator px-2 py-1 rounded-md bg-blue-900"></i>
        <h1 class="font-bold text-gray-200 text-[15px] ml-3">JOHAN PERDOMO</h1>
        <i
